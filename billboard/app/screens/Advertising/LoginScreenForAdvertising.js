...
export default function LoginScreenForOwner() {
    ...
    const { loginForAdvertising } = useContext(AuthContext);
            ...
            <SafeAreaView style={{ flex: 1 }}>
                <ScrollView contentContainerStyle={styles.container}>
                    ...
                    <Formik
                        ...
                        onSubmit={async ({ email, password }) => await loginForAdvertising(email, password)}
                        ...
                        {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                            <>
                                ...
                                <View style={styles.buttonContainer}>
                                    ...
                                    <CustomButton text='Kayıt Ol' onPress={() => navigation.navigate('RegisterAds')} />
                                    <TouchableOpacity onPress={() => navigation.navigate('Login')}>
                                        <Text style={styles.isAdvertisingText}>Billboard sahibi misin?</Text>
                                    </TouchableOpacity>
                                </View>
                            </>
                        )}
