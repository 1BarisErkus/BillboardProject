...
export default function RegisterScreenForAdvertising() {
        ...
        >
            <ScrollView contentContainerStyle={styles.container}>
                <Formik
                    ...
                    onSubmit={({ fullName, email, phoneNumber, password, passwordConfirm }) => register(fullName, email, phoneNumber, password, passwordConfirm, 1)}
